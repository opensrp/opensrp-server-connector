...
public class AllFailedEventsCouchImpl implements AllFailedEvents {
	...
	public void addOrUpdate(FailedEvent failedEvent) {
		...
		if (existing != null) {
			...
			org.opensrp.connector.atomfeed.domain.FailedEvent fEvent = new org.opensrp.connector.atomfeed.domain.FailedEvent(
			        failedEvent.getFeedUri(), failedEvent, failedEvent.getErrorMessage(), failedEvent.getRetries());
	...
	public class AllFailedEventInnerRepository extends BaseRepository<org.opensrp.connector.atomfeed.domain.FailedEvent> {
		...
		public org.opensrp.connector.atomfeed.domain.FailedEvent findByFeedUriAndEventId(String feedUri, String eventId) {
			...
			List<org.opensrp.connector.atomfeed.domain.FailedEvent> ol = db.queryView(
			    createQuery("all_failed_events_by_feed_uri_and_event_id").key(ckey).includeDocs(true),
			    org.opensrp.connector.atomfeed.domain.FailedEvent.class);
		...
		public List<org.opensrp.connector.atomfeed.domain.FailedEvent> findByFeedUri(String feedUri) {
			List<org.opensrp.connector.atomfeed.domain.FailedEvent> ol = db.queryView(
			    createQuery("all_failed_events_by_feed_uri").key(feedUri).includeDocs(true),
			    org.opensrp.connector.atomfeed.domain.FailedEvent.class);
			return ol;
		}
		...
		public org.opensrp.connector.atomfeed.domain.FailedEvent findByEventId(String eventId) {
			List<org.opensrp.connector.atomfeed.domain.FailedEvent> ol = db.queryView(
			    createQuery("all_failed_events_event_id").key(eventId).includeDocs(true),
			    org.opensrp.connector.atomfeed.domain.FailedEvent.class);
