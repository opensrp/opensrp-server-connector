...
public abstract class OpenmrsApiService extends TestResourceLoader {
	...
	public String locationTagname = "TestLocatinTag";
	
	public String locationTagnameUpdated = "TestLocatinTagUpdate";
	
	public String LOCATIONNAE = "testLocationName";
	
	public String LOCATIONNAMEUPDATED = "testLocationNameUpdated";
